 ...
 *
 * arch/x86_64/msvc_asm.h - Declarations for MASM routines (MSVC, x86_64)
 *
 * ALL raw CPU instruction sequences are implemented in msvc_asm.asm.
 * No inline asm or compiler intrinsics belong in .h or .cpp files.
 *
 * Porting guide: for a new architecture, create
 *   include/vkernel/arch/<target>/msvc_asm.h   (this file's counterpart)
 *   src/arch/<target>/msvc_asm.asm              (implementations)
 * and provide the same asm_* symbols listed here.
 */

#ifndef VKERNEL_ARCH_X86_64_MSVC_ASM_H
#define VKERNEL_ARCH_X86_64_MSVC_ASM_H
...
#endif /* VKERNEL_ARCH_X86_64_MSVC_ASM_H */
