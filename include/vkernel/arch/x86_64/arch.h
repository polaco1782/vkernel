...
/* XSAVE / XRSTOR — save/restore x87 + SSE + AVX state (2696 bytes, 64B aligned) */
inline constexpr u64 XSAVE_MASK_X87_SSE_AVX = 0x7;
inline auto xsave(void* area)        -> void { asm_xsave(area, XSAVE_MASK_X87_SSE_AVX); }
inline auto xrstor(const void* area) -> void { asm_xrstor(area, XSAVE_MASK_X87_SSE_AVX); }
