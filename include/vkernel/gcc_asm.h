 ...
 *
 * gcc_asm.h - Compatibility redirect to arch/x86_64/gcc_asm.h
 *
 ...
 * arch code should include "gcc_asm.h" relative to its own directory.
 */

#ifndef VKERNEL_GCC_ASM_H
#define VKERNEL_GCC_ASM_H

#include "arch/x86_64/gcc_asm.h"
